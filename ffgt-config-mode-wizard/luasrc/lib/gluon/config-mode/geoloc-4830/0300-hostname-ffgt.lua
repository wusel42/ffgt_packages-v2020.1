return function(form, uci)
    ...
    hostname = hostname:gsub("^ffbb%-", "")
    hostname = hostname:gsub("^FFBB%-", "")
    hostname = hostname:gsub("^ffce%-", "")
    hostname = hostname:gsub("^FFCE%-", "")
    hostname = hostname:gsub("^ffgf%-", "")
    hostname = hostname:gsub("^FFGF%-", "")
    hostname = hostname:gsub("^ffue%-", "")
    hostname = hostname:gsub("^FFUE%-", "")
    hostname = hostname:gsub("^FreifunkUE%-", "")
    hostname = hostname:gsub("^ffsueh%-", "")
    hostname = hostname:gsub("^ffwdl%-", "")
